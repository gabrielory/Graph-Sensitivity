...
# defines a class representing P_m ⊙ K_n graphs that inherits from GraphFamily
class CoronaGraphs(GraphFamily):
    def __init__(self):
        super().__init__()
        self.name = "CoronaGraphs - G = P_m, H = K_n"
        self.notation = "P_m ⊙ K_n "
...
︡fd8bcf37-4995-4f93-b770-68e1a8d9f001︡{"stdout":"CoronaGraphs - G = P_m, H = K_nResults done"}︡{"stdout":"\n"}︡{"stdout":"CoronaGraphs - G = P_m, H = K_nSensitivityResults done"}︡{"stdout":"\n"}︡{"done":true}

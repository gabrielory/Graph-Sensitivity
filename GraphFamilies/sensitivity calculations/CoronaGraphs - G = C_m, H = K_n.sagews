︠dbcadf91-cfc4-4fad-9999-ab97c649a459s︠
attach('../GraphFamily.sage')
attach('../corona_product.sage')
from tabulate import tabulate

# defines a class representing C_m ⊙ K_n graphs that inherits from GraphFamily
class CoronaGraphs(GraphFamily):
    def __init__(self):
        super().__init__()
        self.name = "CoronaGraphs - G = C_m, H = K_n"
        self.notation = "C_m ⊙ K_n "
...
︡19dca296-ea7b-42f0-a2d8-028ef22731a6︡{"stdout":"CoronaGraphs - G = C_m, H = K_nResults done"}︡{"stdout":"\n"}︡{"stdout":"CoronaGraphs - G = C_m, H = K_nSensitivityResults done"}︡{"stdout":"\n"}︡{"done":true}

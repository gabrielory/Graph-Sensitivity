...
# defines a class representing nH for H = Pℓ that inherits from nHGraphFamily
class nPlGraphs(nHGraphFamily):
    def __init__(self):
        super().__init__()
        self.name = "nPlGraphs"
        self.min_l = 2
...
#g.output_ksensitivity(4,5)
︡fd76ce4f-6276-4dfe-ae08-a150dd79bc6d︡{"stdout":"nPlGraphsKSensitivityTablesDone\n"}︡{"done":true}

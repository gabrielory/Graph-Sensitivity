︠08a8052a-0b11-424d-b702-7c4b43c553fes︠
...
class UnnamedGraphs(OneVarGraphFamily):
    def __init__(self):
        super().__init__()
        self.name = "Corollary 5-4 Graphs - H = Cn, H' ="
        self.min_n = 5
...
︡a3185208-fbff-4a19-a883-2bdec3a06a2e︡{"stdout":"Corollary 5-4 Graphs - H = Cn, H' = K2 Results done\nCorollary 5-4 Graphs - H = Cn, H' = K3 Results done\nCorollary 5-4 Graphs - H = Cn, H' = P3 Results done\nCorollary 5-4 Graphs - H = Cn, H' = K4 Results done"}︡{"stdout":"\nCorollary 5-4 Graphs - H = Cn, H' = Diamond Results done\nCorollary 5-4 Graphs - H = Cn, H' = Paw Results done"}︡{"stdout":"\nCorollary 5-4 Graphs - H = Cn, H' = C4 Results done\nCorollary 5-4 Graphs - H = Cn, H' = K1,3 Results done"}︡{"stdout":"\nCorollary 5-4 Graphs - H = Cn, H' = P4 Results done\nCorollary 5-4 Graphs - H = Cn, H' = K5 Results done\n"}︡{"done":true}

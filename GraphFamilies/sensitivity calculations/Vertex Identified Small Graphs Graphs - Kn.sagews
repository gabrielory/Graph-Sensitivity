︠af160fff-c31c-4b04-9b95-12681bc49280s︠
...
class UnnamedGraphs(OneVarGraphFamily):
    def __init__(self):
        super().__init__()
        self.name = "Corollary 5-4 Graphs - H = Kn, H' ="
        self.min_n = 2
...
︡e4ef7c07-ea67-4688-85bb-daff205ea739︡{"stdout":"Corollary 5-4 Graphs - H = Kn, H' = K2 Results done\nCorollary 5-4 Graphs - H = Kn, H' = K3 Results done\nCorollary 5-4 Graphs - H = Kn, H' = P3 Results done\nCorollary 5-4 Graphs - H = Kn, H' = K4 Results done"}︡{"stdout":"\nCorollary 5-4 Graphs - H = Kn, H' = Diamond Results done\nCorollary 5-4 Graphs - H = Kn, H' = Paw Results done"}︡{"stdout":"\nCorollary 5-4 Graphs - H = Kn, H' = C4 Results done\nCorollary 5-4 Graphs - H = Kn, H' = K1,3 Results done\nCorollary 5-4 Graphs - H = Kn, H' = P4 Results done"}︡{"stdout":"\nCorollary 5-4 Graphs - H = Kn, H' = K5 Results done\n"}︡{"done":true}
